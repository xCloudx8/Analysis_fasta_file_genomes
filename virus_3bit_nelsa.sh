...
for f in "${VIRUSES[@]}"
do
   java -cp IGTools_cli.jar igtools.cli.util.FASTATo3bit /home/daniele/Documents/Project/Virus/"$f".fna "$f".3bit
   mv "$f.3bit" /home/daniele/Documents/Project/Virus/Virus_3Bit
   echo "$f done"
   echo ""
done
...
for f in "${VIRUSES[@]}"
do
   java -cp IGTools_cli.jar igtools.cli.dictionaries.BuildNELSA /home/daniele/Documents/Project/Virus/Virus_3Bit/"$f".3bit "$f".nelsa
   mv "$f.nelsa" /home/daniele/Documents/Project/Virus/Virus_nelsa
   echo "$f done"
   echo ""
done
